...
SECTIONS = {
    ...
    "windfuryReceived":    Section(LOG,  False, desc="per-non-shaman-melee Windfury Totem extra-attack procs received (SPELL_EXTRA_ATTACKS; log-only, empty without a log / no enh shaman)"),
    ...
    "saves":               Section(WCL,  False,
                                   desc="protective/external casts on allies (paladin Hands, battle-res, reactive utility)"),
    "dispels":             Section(WCL,  False,
                                   desc="who-dispelled-what — cleanses off allies + offensive purges on enemies (WCL Dispels events)"),
